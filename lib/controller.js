...
function collectMiddlewares(scope, base) {
  if (!base) base = [];
  if (this.parent instanceof Controller)
    base = collectMiddlewares.call(this.parent, scope, base);
...
Controller.prototype.middleware = Controller.prototype.use = function middleware() {

...
module.exports = function createController() {
  ...
  const injectRouteScope = function(req, res, next) {
...
// collects middleware for a given scope, traverses up the controller tree
// if one exists and collects also middlewares from there.
